...
/**
 * majordomoMailingList.php
 *
 * class managing a majordomo mailing list via automatic email functions call
 *
 ...
 * @version    CVS: $Id: majordomoMailingList.php,v 1.1.2.2 2005/10/28 17:44:06 claratte Exp $
...
class majordomoMailingList extends genericMailingList
{
    /**
    ...
    */
	...
	{
		$this->notifyByMail($_email,'majordomo@'.$this->domain,'subscribe '.$this->_name);
	}
    ...
    */
	...
	{
		$this->notifyByMail($_email,'majordomo@'.$this->domain,'unsubscribe '.$this->_name);
	}
}
?>