 ...
 * freeMailingList.php
 *
 * manage a free mailing list via automatic email functions call
 *
 ...
 * @version    CVS: $Id: freeMailingList.php,v 1.1.2.2 2005/10/28 17:44:06 claratte Exp $
...
class freeMailingList extends genericMailingList
{
    /**
	...
	{
		$this->notifyByMail($_email,$this->_name.'-request@'.$this->_domain, 'subscribe '.$_email);
	}
	...
	{
		$this->notifyByMail($_email,$this->_name.'-request@'.$this->_domain, 'unsubscribe '.$_email);
	}
}
?>