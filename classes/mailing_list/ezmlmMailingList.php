...
/**
 * ezmlmMailingList.php
 *
 * manage an ezmlm mailing list via automatic email functions call
 *
 ...
 * @version    CVS: $Id: ezmlmMailingList.php,v 1.1.2.2 2005/10/28 17:44:06 claratte Exp $
...
class ezmlmMailingList extends genericMailingList
{
    /**
    ...
    */
	function subscribe($_email)
	{
		...
		$this->notifyByMail('postmaster@'.$_domain, $_name.'-subscribe-'.$_email.'@'.$_domain);
	}
    ...
    */
	...
	{
		$_email=str_replace('@','=',$_email);
		$this->notifyByMail('postmaster@'.$_domain, $_name.'-unsubscribe-'.$_email.'@'.$_domain);
	}
}
?>